...
const offersBase = Offers.filter((offer) => (offer.cityId === 1));
...
describe(`Reducer tests`, () => {
  ...
  it(`Reducer should return new offers`, () => {
    const offersCurrent = Offers.filter((offer) => (offer.cityId === 4));
